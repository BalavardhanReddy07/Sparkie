...
SessionId = 019ef50b-c80c-7bee-b2b8-a05134e9b612
document_File_Paths = 1JD9j000001btWPGAY/Brighter Super Member Guide.pdf
Flow start time: <b>24 June 2026 at 1:19 am</b>.
...
Inputs:
session-id = {!SessionId} (019ef50b-c80c-7bee-b2b8-a05134e9b612)
...
200
{
  ...
  "x5flinks": {
    ...
    "z0end": {
      "href_set": true,
      "href": "https://api.salesforce.com/einstein/ai-agent/v1/sessions/019ef50b-c80c-7bee-b2b8-a05134e9b612"
    },
    "session_set": true,
    "session": {
      "href_set": true,
    ...
    "messages": {
      "href_set": true,
      "href": "https://api.salesforce.com/einstein/ai-agent/v1/sessions/019ef50b-c80c-7bee-b2b8-a05134e9b612/messages"
    }
  },
  "messages_set": true,
  "messages": [
    {
      ...
      "InformMessage": {
        ...
        "result": [],
        "planId_set": true,
        "planId": "bbbc2d87-8f56-48f1-ba97-a41a205d5adb",
        "metrics_set": true,
        "metrics": {},
        "message_set": true,
        "message": "You have successfully selected an L2 document. If you need details or specific information from the Brighter Super Fund Business Rules or Brighter Super Member Guide, please let me know which document and section you want to explore further. What would you like to do next?",
        "isContentSafe_set": true,
        "isContentSafe": true,
        "id_set": true,
        "id": "92cdee47-9636-4a2f-844e-03b25f7a2c77",
        "feedbackId_set": true,
        "feedbackId": "bbbc2d87-8f56-48f1-ba97-a41a205d5adb",
...
The flow interview ran for 8.20 seconds and finished on 24 June 2026 at 1:19 am.
