...
I changed the Session ID and tried again then I got this flow debug
...
API Version for Running the Flow: 67
Some of this flow's variables were set when the interview started.
SessionId = 83d68e64-a867-42f9-89b9-b160c6e229e5
document_File_Paths = 1JD9j000001btWPGAY/Brighter Super Member Guide.pdf
Flow start time: <b>23 June 2026 at 6:46 pm</b>.
...
We couldn't run action  AIAgentAPIV1.sendMessage  because something went wrong.
Inputs:
session-id = {!SessionId} (83d68e64-a867-42f9-89b9-b160c6e229e5)
x-sfdc-tenant-id = test
body = {!var_MessageBody}
{
  "variables_set": true,
...
{
  "timestamp_set": true,
  "timestamp": 1782204405897,
  "status_set": true,
  "status": 404,
  "requestId_set": true,
  "requestId": "d88b3ff1-d289-45de-a878-badcc52cb072",
  "path_set": true,
  "path": "v6.0.0/sessions/83d68e64-a867-42f9-89b9-b160c6e229e5/messages",
  "message_set": true,
  "message": "V6Session not found for sessionId: 83d68e64-a867-42f9-89b9-b160c6e229e5",
  "error_set": true,
  "error": "NotFoundException"
}
responseCode (404)
...
An Error Occurred
The flow interview failed on 23 June 2026 at 6:46 pm. It ran for 9.16 seconds.
