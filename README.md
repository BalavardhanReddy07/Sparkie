...
I am going to send the Output from the flow as "{!Loop_Through_Relationship_Records.Products__r.Account_Number__c} - {!Loop_Through_Relationship_Records.Products__r.Designation__c} -- {!Loop_Through_Relationship_Records.Products__r.Scheme_Category__c} "

can you please display the Account number - Designation(AccountType) as it is and 
return the Scheme_Category__c ?


Or else if you have ay better approach to set this say to me 
